        ...
        m.prototype = {
          ...
          $watchCollection: function (a, b) {
            function c(a) {
              ...
              if (!z(e)) {
                if (D(e))
                  if (ya(e)) for (f !== n && ((f = n), (t = f.length = 0), l++), a = e.length, t !== a && (l++, (f.length = t = a)), b = 0; b < a; b++) (h = f[b]), (g = e[b]), (d = h !== h && g !== g), d || h === g || (l++, (f[b] = g));
                  else {
                    f !== p && ((f = p = {}), (t = 0), l++);
                    a = 0;
    ...
    readString: function (a) {
      ...
      for (var d = '', c = a, e = !1; this.index < this.text.length; ) {
        var f = this.text.charAt(this.index),
          c = c + f;
        if (e) 'u' === f ? ((e = this.text.substring(this.index + 1, this.index + 5)), e.match(/[\da-f]{4}/i) || this.throwError('Invalid unicode escape [\\u' + e + ']'), (this.index += 4), (d += String.fromCharCode(parseInt(e, 16)))) : (d += rh[f] || f), (e = !1);
        else if ('\\' === f) e = !0;
        else {
          if (f === a) {
            this.index++;
