Feature: Final display for FTPA decision and reasons
  ...
  @RIA-2919 @RIA-2919-scenario3 @RIA-2919-scenario3a
  ...
  Scenario: FTPA judge decision - Granted
    ...
    And I should see the `Overview` page
    And I should see the image `ftpaGranted.svg`
    And I should not see the image `ftpaGrantedPartiallyGranted.svg`
  ...
  @RIA-2919 @RIA-2919-scenario3 @RIA-2919-scenario3b
