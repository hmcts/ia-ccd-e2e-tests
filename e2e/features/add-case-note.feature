Feature: Add a case note
  ...
  @regression @add-case-note @RIA-575 @appeal-nightly-test @testy-test
  Scenario: Add a case note with document
    ...
    And within the `Case notes` collection's first item, I should see one of `Case Officer,IAC Demo TCW` for the `User` field
