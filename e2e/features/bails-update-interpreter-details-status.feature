Feature: Bails Update interpreter details application as Legal Rep
  Background:
    ...
    And I wait for 10 seconds
  @submit-bail-application @RIA-5661 @submit-bail-application-legal-rep @bails-full @bails-regression @xbrowsertestBails @nightly-test @bail-interpreterdetails
 ...
 @submit-bail-application @RIA-5661 @submit-bail-application-legal-rep @bails-full @bails-regression @xbrowsertestBails @nightly-test @bail-interpreterstatus
