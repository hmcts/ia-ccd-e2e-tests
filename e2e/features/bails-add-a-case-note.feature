Feature: Add a case note to bails application
 Background:
  ...
  @bails-add-case-note @bails-add-case-note-admin-officer @bails-add-case-note-document @bails-add-case-note-document-admin-officer @RIA-5753
  ...
  @bails-add-case-note @bails-add-case-note-judge @bails-add-case-note-document @bails-add-case-note-document-judge @RIA-5753
  ...
  @bails-add-case-note @bails-add-case-note-admin-officer @RIA-5753
  ...
  @bails-add-case-note @bails-add-case-note-judge @RIA-5753
