Feature: Add a case note to bails application
 Background:
  ...
  @bails-add-case-note @bails-add-case-note-admin-officer @bails-add-case-note-document @bails-add-case-note-document-admin-officer
  ...
  @bails-add-case-note @bails-add-case-note-judge @bails-add-case-note-document @bails-add-case-note-document-judge
  ...
  @bails-add-case-note @bails-add-case-note-admin-officer
  ...
  @bails-add-case-note @bails-add-case-note-judge
