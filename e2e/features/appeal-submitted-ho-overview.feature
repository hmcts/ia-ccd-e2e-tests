Feature: Overview page for Home Office users for Appeal submitted
  ...
  Scenario: Overview page for Home Office users after appeal submitted (EA appeal type) with payment method (Pay by card)
    ...
    And I should see the text `Refusal of application under the EEA regulations`
