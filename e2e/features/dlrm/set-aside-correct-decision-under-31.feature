Feature: Update Tribunal Decision for Decided and FTPA Decided cases
  ...
  @set-aside-dlrm @RIA-8157 @dlrm-works
  Scenario Outline: Correct decision error under rule 31
    ...
    #   | No                                |
    And I click the `Yes, change decision to Allowed` label
    ...
    And I should see `Yes, change decision to Allowed` in the `Do you want to change the decision?` field
