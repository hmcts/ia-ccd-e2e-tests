Feature: Create EA case upto FTPA submitted
  ...
  Background:
    ...
    And I save my initial internal EU appeal type without remission and with hearing fee and pay now
    And I wait for 10 seconds
    And I click the `Close and Return to case details` button if present
    And I pay for and submit my internal appeal by Card for a non PA appeal type
