...
Given(/^I edit my submitted application as a `Admin Officer` for a (Prison|Immigration removal centre) detention with (no|one|two) financial condition supporters and with (a|no) Legal Representative that had (a|no) Legal Representative before$/,
    async function (
    detentionFacility,
    noOfSupporters,
    legalRepresentativeOrNot,
    previousLegalRepresentativeOrNot) {
