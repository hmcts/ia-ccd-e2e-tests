...
Given('I upload the signed decision notice for a refusal', async() => {
  await uploadSignedDecisionNotice.uploadSignedDecisionNotice(true, 'Refused');
});

Given('I upload the signed decision notice for a grant', async() => {
  await uploadSignedDecisionNotice.uploadSignedDecisionNotice(true, 'Granted');
});

Given('I upload the signed decision notice for a conditional grant', async() => {
