...
#    And I request home office data
    ...
    And I go to the URL `https://manage-case.aat.platform.hmcts.net/cases/case-details/1749551169825300#Overview`

  @regression @create-direction @RIA-892 @RIA-2694 @appeal-nightly-test @appeal-nightly-test1
