Feature: Pay and submit appeal by PBA - successful and failed payments (EA appeal type)
  ...
  Background:
    ...
    Then I should see the text `You need to pay for your appeal within 14 days of receiving the notification or the Tribunal will end the appeal.`
  ...
  @RIA-6104-pay-and-submit-pba-successful @RIA-6104-pay-and-submit-pba-successful-ea @nightly-test
  ...
  Scenario: Pay and submit appeal - failed payment (EA appeal type)
  ...
  Scenario: Pay and submit appeal - failed payment 2 (EA appeal type)
