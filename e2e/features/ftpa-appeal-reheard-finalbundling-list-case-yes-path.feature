Feature: Case Officer create a new hearing bundle for a reheard case
  ...
  @RIA-3130-yes-path @RIA-3130
  Scenario: Case Officer generate a new hearing bundle for a reheard case for 'Yes' options selected for submit hearing requirements
