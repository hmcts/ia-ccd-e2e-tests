Feature: Send direction
  ...
  @RIA-5772 @bails-change-direction-due-date @bails-change-direction-due-date-AO @bails
  Scenario: Change a direction due date as an Admin Officer
    ...
    Then I should see an alert confirming the case `has been updated with event: Change direction due date`
