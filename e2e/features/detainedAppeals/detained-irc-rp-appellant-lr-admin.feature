Feature: Progress Internal Lr Detained RP Appeal upto FTPA decided

  Background:
    Given I am signed in as a `Admin Officer`
    And I create a new case
    And I save my initial lr internal RP appeal for nonPayment without hearing for an Immigration removal centre detention facility
  ...
  @lrInternalDetained-rp-case  @detained-cases
  Scenario: FTPA judge decision - Dispose of application under rule 32/Review decision under rule 35 - Resident Judge only
