Feature: Progress Internal Aip Detained PA Appeal upto FTPA decided

  Background:
    Given I am signed in as a `Admin Officer`
    And I create a new case
    And I save my initial aip internal PA appeal type without remission and with hearing fee and pay now for an other facility
    ...
    And I select how each of the 5 participants will attend the hearing
    And I click the `Continue` button
  ...
  @aipInternalDetained-pa-case @detained-cases
  Scenario: FTPA judge decision - Dispose of application under rule 31/Application not admitted
