Feature: Progress Internal Lr Detained EU Appeal upto CMR Hearing
  ...
  @lrInternalDetained-eu-case @detained-cases-upto-cmr-hearing
  Scenario: Progress Internal Lr Detained EU Appeal upto CMR Hearing
