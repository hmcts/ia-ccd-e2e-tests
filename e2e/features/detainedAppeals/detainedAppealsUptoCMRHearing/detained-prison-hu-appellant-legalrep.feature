Feature: Progress Detained HU Appeal upto CMR Hearing
  ...
  @detained-hu-case @detained-cases-upto-cmr-hearing
  Scenario: Progress Detained HU Appeal upto CMR Hearing
