Feature: Progress Internal Lr Detained RP Appeal upto CMR Hearing
  ...
  @lrInternalDetained-rp-case  @detained-cases-upto-cmr-hearing
  Scenario: Progress Internal Lr Detained RP Appeal upto CMR Hearing
    ##Hearing Request
    And I switch to be a `Admin Officer`
