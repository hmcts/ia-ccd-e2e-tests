Feature: Progress Internal Aip Detained EA Appeal upto CMR Hearing

  Background:
    Given I am signed in as a `Admin Officer`
    And I create a new case
    And I save my initial aip internal EA appeal type without remission and with hearing fee and pay now for an prison facility
  ...
  @aipInternalDetained-ea-case @detained-cases-upto-cmr-hearing
  Scenario: Progress Internal Aip Detained EA Appeal upto CMR Hearing
