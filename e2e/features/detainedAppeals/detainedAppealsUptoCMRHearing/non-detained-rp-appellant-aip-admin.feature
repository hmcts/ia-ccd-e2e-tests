Feature: Progress Internal Aip NonDetained RP Appeal upto CMR Hearing
  ...
  Background:
    ...
    And I save my initial aip internal RP nondetained appeal for nonPayment without hearing
  ...
  Scenario: Progress Internal Aip NonDetained RP Appeal upto CMR Hearing
