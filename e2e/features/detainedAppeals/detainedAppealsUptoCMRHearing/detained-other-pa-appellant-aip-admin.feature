Feature: Progress Internal Aip Detained PA Appeal upto CMR Hearing
  ...
  @aipInternalDetained-pa-case @detained-cases-upto-cmr-hearing
  Scenario: Progress Internal Aip Detained PA Appeal upto CMR Hearing
