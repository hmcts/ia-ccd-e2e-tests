Feature: Progress Detained RP Appeal upto CMR Hearing
  ...
  @detained-rp-case @detained-cases-upto-cmr-hearingneedsfix
  Scenario: Progress Detained RP Appeal upto CMR Hearing
