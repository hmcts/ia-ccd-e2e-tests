Feature: Progress Detained PA Appeal upto CMR Hearing

  Background:
    Given I am signed in as a `Legal Org User Rep A`
    And I create a new case
    And I save my initial PA appeal type without remission and with hearing fee and pay now for an other facility
  ...
  @detained-pa-case @detained-cases-upto-cmr-hearing
  Scenario: Progress Detained PA Appeal upto CMR Hearing
