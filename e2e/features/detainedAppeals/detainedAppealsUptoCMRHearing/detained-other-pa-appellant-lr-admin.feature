Feature: Progress Internal Lr Detained PA Appeal upto CMR Hearing
  ...
  @lrInternalDetained-pa-case  @detained-cases-upto-cmr-hearing
  Scenario: Progress Internal Lr Detained PA Appeal upto CMR Hearing
