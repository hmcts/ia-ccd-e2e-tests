Feature: Detained RP hearing request
  ...
  @detained-rp-case
  Scenario: Detained hearing request flow for RP appeal

    When I save my initial RP appeal for nonPayment without hearing for an Immigration removal centre detention facility
