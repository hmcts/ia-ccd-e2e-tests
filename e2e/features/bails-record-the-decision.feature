Feature: Record the decision
 Background:
  ...
  Scenario: Granted case - SS consent No
    ...
    And I type `The applicant is to appear before an Immigration Officer at Big Ben between 11am and 1pm on 1st January 2023 or any other place and on any other date and time that may be required by the Home Office or an Immigration Officer. \n -OR- \n The Applicant must appear before an Immigration Officer on a date and time and by such means as may be notified to him by the Home Office in writing.` for the `Enter the appearance conditions the applicant will be subject to` field
    And I type `The Applicant shall not undertake the activities listed below while on immigration bail without further order: \n The Applicant is not allowed to work` for the `Enter the activities conditions the applicant will be subject to` field
    And I type `The applicant must reside at 123 Fake Street. \n Where an Immigration Judge makes a conditional grant with deferred commencement: \n The applicant will reside at an address approved by the probation/offender manager. \n By virtue of para 3(8) of schedule 10 of The Immigration Act 2016 this grant of bail will not commence until such address has been approved by probation. \n The approval of a residence address will be reviewed by the Tribunal on the first available date after [ ] days unless the Tribunal is notified prior to that date that accommodation has been approved and bail commenced in which case the matter will be dealt with administratively. \n In the event that the applicant has not been released then at least 2 clear days before the bail review hearing, the Secretary of State is to update the Tribunal in writing as to the progress made in relation to sourcing and/or approving accommodation for the applicant.` for the `Enter the residence conditions the applicant will be subject to` field
    ...
    And I type `Note: Where the Tribunal has directed that the Applicant should be subject to an electronic monitoring condition there may be a delay of release of up to 72 hours pending arrangements for the electronic monitoring device. \n Bail is granted conditional upon: \nthe applicant being compliant with the fitting of an electronic monitoring device at the point of release from detention; and \n the Secretary of State promptly arranging the fitting of the electronic monitoring device at the place of the Applicant's detention. If the secretary of State does not complete the fitting of the electronic monitoring device within 72 hours then this grant of bail will commence and the applicant is to be released subject to the other conditions of this grant of bail. In such an event the Secretary of State will make arrangements for the fitting of the electronic monitoring device post release.` for the `Enter the electronic monitoring conditions the applicant will be subject to` field
    ...
    And I should see `The applicant is to appear before an Immigration Officer at Big Ben between 11am and 1pm on 1st January 2023 or any other place and on any other date and time that may be required by the Home Office or an Immigration Officer. \n -OR- \n The Applicant must appear before an Immigration Officer on a date and time and by such means as may be notified to him by the Home Office in writing.` for the `Enter the appearance conditions the applicant will be subject to` field
    And I should see `The Applicant shall not undertake the activities listed below while on immigration bail without further order: \n The Applicant is not allowed to work` for the `Enter the activities conditions the applicant will be subject to` field
    And I should see `The applicant must reside at 123 Fake Street. \n Where an Immigration Judge makes a conditional grant with deferred commencement: \n The applicant will reside at an address approved by the probation/offender manager. \n By virtue of para 3(8) of schedule 10 of The Immigration Act 2016 this grant of bail will not commence until such address has been approved by probation. \n The approval of a residence address will be reviewed by the Tribunal on the first available date after [ ] days unless the Tribunal is notified prior to that date that accommodation has been approved and bail commenced in which case the matter will be dealt with administratively. \n In the event that the applicant has not been released then at least 2 clear days before the bail review hearing, the Secretary of State is to update the Tribunal in writing as to the progress made in relation to sourcing and/or approving accommodation for the applicant.` for the `Enter the residence conditions the applicant will be subject to` field
    ...
    And I should see `Note: Where the Tribunal has directed that the Applicant should be subject to an electronic monitoring condition there may be a delay of release of up to 72 hours pending arrangements for the electronic monitoring device. \n Bail is granted conditional upon: \nthe applicant being compliant with the fitting of an electronic monitoring device at the point of release from detention; and \n the Secretary of State promptly arranging the fitting of the electronic monitoring device at the place of the Applicant's detention. If the secretary of State does not complete the fitting of the electronic monitoring device within 72 hours then this grant of bail will commence and the applicant is to be released subject to the other conditions of this grant of bail. In such an event the Secretary of State will make arrangements for the fitting of the electronic monitoring device post release.` for the `Enter the electronic monitoring conditions the applicant will be subject to` field
    ...
    And I should see `500` for the `Amount (£)` field
  ...
  Scenario: Granted case - SS consent Yes
    ...
    And I click the `Continue` button
    Then I am on the `Reasons for decision` page
    When I type `This is a reason for minding to grant. \n This is another reason to grant.` for the `Enter the reasons the judge is minded to grant bail` field
    And I click the `Continue` button
    Then I am on the `Secretary of State consent decision` page
    ...
    And I should see `Yes` for the `Is Secretary of State consent needed?` field
    And I should see `Minded to grant` for the `What is the Tribunal's decision?` field
    And I should see `This is a reason for minding to grant. \n This is another reason to grant.` for the `Enter the reasons the judge is minded to grant bail` field
