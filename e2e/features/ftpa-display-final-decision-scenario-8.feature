Feature: Final display for FTPA decision and reasons
  ...
  @RIA-2919 @RIA-2919-scenario8 @RIA-2919-scenario8a @RIA-2919-scenario8a-1
  ...
  @RIA-2919 @RIA-2919-scenario8 @RIA-2919-scenario8a @RIA-2919-scenario8a-2
  ...
  @RIA-2919 @RIA-2919-scenario8 @RIA-2919-scenario8a @RIA-2919-scenario8a-3
  ...
  Scenario: FTPA judge decision - Granted
    ...
    Then I should see the `Overview` page
    And I should see the image `ftpaGranted.svg`
    And I should not see the image `appeal_allowed.svg`
  ...
  @RIA-2919 @RIA-2919-scenario8 @RIA-2919-scenario8b @RIA-2919-scenario8b-1
  ...
  @RIA-2919 @RIA-2919-scenario8 @RIA-2919-scenario8b @RIA-2919-scenario8b-2
  ...
  @RIA-2919 @RIA-2919-scenario8 @RIA-2919-scenario8b @RIA-2919-scenario8b-3
