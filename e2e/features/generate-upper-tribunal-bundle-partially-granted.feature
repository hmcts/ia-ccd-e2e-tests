Feature: Generate Upper Tribunal Bundle (FTPA partially granted)
  ...
  @RIA-4351 @RIA-4351-partially-granted @RIA-4351-partially-granted-leadership-judge-appellant
  Scenario: Generate Upper Tribunal Bundle - FTPA Partially Granted (Leadership Judge / Appellant)
  ...
  @RIA-4351 @RIA-4351-partially-granted @RIA-4351-partially-granted-leadership-judge-respondent
  Scenario: Generate Upper Tribunal Bundle - FTPA Partially Granted (Leadership Judge / Respondent)
  ...
  @RIA-4351 @RIA-4351-partially-granted-2 @RIA-4351-partially-granted-resident-judge-appellant
  Scenario: Generate Upper Tribunal Bundle - FTPA Partially Granted (Resident Judge / Appellant)
  ...
  @RIA-4351 @RIA-4351-partially-granted-2 @RIA-4351-partially-granted-resident-judge-respondent
  Scenario: Generate Upper Tribunal Bundle - FTPA Partially Granted (Resident Judge / Respondent)
