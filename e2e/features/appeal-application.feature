Feature: Complete the appeal application online
  ...
  Scenario: Lodge an appeal application (happy path)
    ...
    Given I am on the Has your client appealed against any other UK immigration decisions? page
    When I add a new item to the Other appeals collection
    When Within the Other appeals collection, I type 1234 for the first Other appeals field
    When I add a new item to the Other appeals collection
    When Within the Other appeals collection, I type 5678 for the second Other appeals field
    When I click the Continue button
    ...
    Then Within the Other appeals collection, I should see 1234 for the first Other appeals field
    Then Within the Other appeals collection, I should see 5678 for the second Other appeals field
