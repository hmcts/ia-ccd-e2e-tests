Feature: Bails Submit bail application as Admin Officer
  ...
  Background:
    ...
    Then I save my initial application manually as a `Admin Officer` for a Prison detention with two financial condition supporters and with no Legal Representative
