Feature: Work allocation R2 exclusion scenarios
  ...
  @legal-Ops @RIA-4923 @legal-ops-exclude-himself @work-allocation
  ...
  @legal-Ops @RIA-4923 @legal-ops-exclude-another-person @work-allocation
  ...
  @judicial @RIA-4923 @judicial-exclude-himself @work-allocation
  ...
  @judicial @RIA-4923 @judicial-exclude-another-person @work-allocation
  ...
  @admin @RIA-4923 @admin-exclude-himself @work-allocation
  ...
  @admin @RIA-4923 @admin-exclude-another-person @work-allocation
