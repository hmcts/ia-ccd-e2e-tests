Feature: Start initial appeal application and validate Home Office decision date and appellant DOB

  @start-appeal-dates-validation @RIA-606
  Scenario: Start initial appeal application
    ...
    And I type `31-10-3018` for the `Enter the date the decision letter was sent` field
    And I click the `Continue` button

    Then I should see the text `Unable to proceed because there are one or more callback Errors or Warnings`
    And I should see the text `You've entered an invalid date. You cannot enter a date in the future.`
    ...
    And I type `31-12-2999` for the `Date of birth` field
