Feature: Payment validation for non-payment appeal type
  ...
  @payment-validation-for-non-payment-appeal-type-RP @payment-validation-for-non-payment_appeal-type @RIA-3617
  ...
  @payment-validation-for-non-payment-appeal-type-DC @payment-validation-for-non-payment_appeal-type @RIA-3617
  ...
  @payment-validation-for-pa-appeal-type-pay-later @RIA-3617
