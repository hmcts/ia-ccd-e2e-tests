Feature: Submit without hearing requirements and no previous hearing recordings for appeal submitted - FTPA reheard decision (resident judge)
  ...
  @ftpa-reheard-feature @RIA-3784-no-hearing-recordings @RIA-3784
  Scenario: Submit without hearing requirements and no previous hearing recordings - FTPA respondent resident judge decision (Reheard Rule 35)
