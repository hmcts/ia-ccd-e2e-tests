Feature: Final display for FTPA decision and reasons
  ...
  @RIA-2919 @RIA-2919-scenario9 @RIA-2919-scenario9a @RIA-2919-scenario9a-1
  ...
  Scenario: FTPA judge decision - Reheard
    ...
    Then I should see the `Overview` page
    And I should see the image `appeal_reheard.svg`
    And I should not see the image `appeal_dismissed.svg`
  ...
  @RIA-2919 @RIA-2919-scenario9 @RIA-2919-scenario9a @RIA-2919-scenario9a-2
  ...
  @RIA-2919 @RIA-2919-scenario9 @RIA-2919-scenario9a @RIA-2919-scenario9a-3
    #  Reheard Rule 35 / Not Admitted (Final Decision: Reheard Rule 35 - Scenario 9)
  Scenario: FTPA judge decision - Reheard
