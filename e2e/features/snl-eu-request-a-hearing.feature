Feature: SnL Flow EU hearing request
  ...
  @nightly-test @snl 
  Scenario: SnL hearing request out in country flow for EU appeal
  ...
  @nightly-test @snl 
  Scenario: SnL hearing request out off country flow for EU appeal
