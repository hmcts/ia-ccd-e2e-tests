Feature: Generate Upper Tribunal Bundle (FTPA refused)
  ...
  @RIA-4351 @RIA-4351-refused @RIA-4351-refused-leadership-judge-appellant
  Scenario: Generate Upper Tribunal Bundle - FTPA Refused (Leadership Judge / Appellant)
    ...
    And I click the `Overview` tab
    Then I should see the image `appeal_dismissed.png`
    And I should see the text `Do this next`
    And I should see the text `You must create a bundle for the Upper Tribunal.`
    And I should see the `Generate the Upper Tribunal bundle` link
    And I should see the option `Generate Upper Tribunal bundle` for the `Next step` field
    ...
    When I switch to be a `Admin Officer`
    Then I should see the image `appeal_dismissed.png`
    Then I should not see the image `ftpaGranted.png`
    And I should see the text `What happens next`
  ...
  @RIA-4351 @RIA-4351-refused @RIA-4351-refused-leadership-judge-respondent
  Scenario: Generate Upper Tribunal Bundle - FTPA Refused (Leadership Judge / Respondent)
  ...
  @RIA-4351 @RIA-4351-refused @RIA-4351-refused-resident-judge-appellant
  Scenario: Generate Upper Tribunal Bundle - FTPA Refused (Resident Judge / Appellant)
  ...
  @RIA-4351 @RIA-4351-refused @RIA-4351-refused-resident-judge-respondent
  Scenario: Generate Upper Tribunal Bundle - FTPA Refused (Resident Judge / Respondent)
