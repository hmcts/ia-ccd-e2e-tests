...
export class RecordDecision {
    ...
    async recordDecision(clickContinue = false, SsConsentYesOrNo: string, tribunalDecision: string, SsConsentDecisionYesOrNo: string, releaseStatusYesOrNo: string, conditions: string[], financialConditionYesOrNo: string, financialConditionDetailsYesOrNo: string, numberOfSupporters: int, yesOrNoForEachSupporter: string[], bailTransferYesOrNo: string) {
        ...
        if (tribunalDecision == 'Refused') {
            await this.completeReasonsForRefusal(true)
