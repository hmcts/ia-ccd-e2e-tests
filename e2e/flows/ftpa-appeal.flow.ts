...
export class FtpaAppealFlow {
  ...
  async submitAppellantAppeal(clickContinue = false) {
    ...
    await this.ccdFormPage.setFieldValue('Document', '{@FTPAAppellantGrounds.pdf}', 'document', 1, 'Grounds of the application', 1);
  ...
  async submitRespondentAppeal(clickContinue = false) {
    ...
    await this.ccdFormPage.setFieldValue('Document', '{@FTPARespondentGrounds.pdf}', 'document', 'first', 'Grounds of the application', 'first');
